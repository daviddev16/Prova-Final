	...
	public MainUI() {
		...
		gl_contentPane.setHorizontalGroup(
				...
				.addGroup(gl_contentPane.createSequentialGroup()
						.addGap(10)
						.addComponent(productsSection, GroupLayout.DEFAULT_SIZE, 310, Short.MAX_VALUE)
						.addGap(10)
						.addComponent(salesSection, GroupLayout.DEFAULT_SIZE, 201, Short.MAX_VALUE)
						.addGap(7))
				.addGroup(gl_contentPane.createSequentialGroup()
						.addGap(10)
						.addComponent(helpSection, GroupLayout.DEFAULT_SIZE, 521, Short.MAX_VALUE)
						.addGap(7))
		...
		gl_contentPane.setVerticalGroup(
				...
				.addGroup(gl_contentPane.createSequentialGroup()
						...
						.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
								...
								.addGroup(gl_contentPane.createSequentialGroup()
										.addComponent(salesSection, GroupLayout.DEFAULT_SIZE, 306, Short.MAX_VALUE)
										.addGap(2)))
						.addGap(2)
						.addComponent(helpSection, GroupLayout.PREFERRED_SIZE, 49, GroupLayout.PREFERRED_SIZE)
						.addGap(2)
